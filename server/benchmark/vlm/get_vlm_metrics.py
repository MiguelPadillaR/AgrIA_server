...
from .constants import BM_JSON_DIR, BM_LLM_DIR, BM_PROMPT_LIST_FILE, BM_SR_IMAGES_DIR, CADASTRAL_REF_LIST_PAPER, DATES_PAPER, FULL_DESC_SYS_INSTR_EN, FULL_DESC_SYS_INSTR_ES, IS_PAPER_DATA, OG_CLASSIFICATION_FILEPATH
...
def get_parcel_data_and_description(cadastral_ref, image_date, lang):
...
def get_llm_full_desc(image_filepath: str, parcel_desc: str, lang: str=None, classification_filepath: str=OG_CLASSIFICATION_FILEPATH):
    json_data = None
    if lang:
