# NOTA ACLARATORIA SOBRE LA APLICACIÓN DE LOS ECO REGÍMENES PAC 2023-2027
...
Este documento ha sido redactado para ayudar a las autoridades competentes, entidades colaboradoras y beneficiarios de la PAC, dada la importancia de los eco regímenes (EERR) en la nueva PAC 2023-2027.  La nota se basa en el Plan Estratégico de la Política Agraria Común (PEPAC) aprobado por la Comisión Europea y el borrador del Real Decreto de Intervenciones PEPAC, el cual ha sido sometido a consulta pública.  Es importante destacar que este documento es solo informativo y su contenido no reemplaza las normas legales aplicables. 

---

## 1. CARACTERÍSTICAS BÁSICAS DEL MODELO DE APLICACIÓN DE ECO REGIMENES EN ESPAÑA 

La adhesión a los eco regímenes (EE.RR.) es voluntaria para el productor, quien decide para qué parcelas de su explotación los solicita y bajo qué prácticas justifica su implementación.  Toda la superficie elegible de la explotación puede acogerse a un eco régimen. 

Para solicitar los eco regímenes, en la Solicitud Única de Ayuda, se debe indicar para cada parcela agrícola: 
1. Si la parcela se acoge o no a uno de los 9 eco regímenes PEPAC. 
2. En caso afirmativo, bajo qué práctica se acoge. 
...
La normativa establece flexibilidades en la aplicación de los eco regímenes. 

### 2.1. Prácticas en tierras de cultivo (incluyendo P5, también en cultivos permanentes) 

#### 2.1.1. P3. Práctica de rotación: 
* **Requisito de rotación:** Generalmente, al menos el 50% de la superficie acogida debe rotar. 
* **Flexibilidades:**
    * Un cultivo secundario en el mismo año que el principal se considerará parte de la rotación. 
    * El porcentaje se puede reducir al 25% si más del 25% de la tierra de cultivo acogida al eco régimen se cultiva con especies plurianuales [cite: 156], o en circunstancias justificadas por la autoridad competente debido a condiciones agroclimáticas adversas. 
    * Si la superficie de tierra de cultivo declarada para esta práctica es menor de 10 hectáreas, la práctica puede consistir en la rotación establecida o, alternativamente, cumplir con el requisito de diversificación de cultivar al menos dos cultivos diferentes, sin que el principal supere el 75% de dicha tierra de cultivo. 
    * La superficie de especies plurianuales no se incluye en el cálculo del porcentaje de rotación.  Sin embargo, en el año en que se implanta un nuevo cultivo después del ciclo plurianual, dicha superficie se incluye como base para el cálculo del 50%.  Por ejemplo, si en 2023 hay alfalfa en 10 ha de 100 ha acogidas, el porcentaje de rotación se calcula sobre 90 ha; si en 2026 se levanta la alfalfa, el porcentaje se calcula sobre 100 ha. 
* **Limitación del barbecho:** El barbecho, considerado cultivo diferente, no puede superar el 20% de las tierras de cultivo acogidas. 
* **Flexibilidades para el barbecho:**
    * En comarcas con pluviometría media inferior o igual a 400 milímetros, el barbecho puede llegar hasta el 40%. 
    * En situaciones de fuerza mayor acreditadas por la autoridad competente, el barbecho también puede llegar hasta el 40%. 
    * Si se cuenta con barbecho semillado en un 10% de la tierra de cultivo acogida, los límites del barbecho pueden incrementarse en 10 puntos porcentuales. 
* **Porcentaje de especies mejorantes:** Al menos el 10% de la superficie de tierra de cultivo acogida al eco régimen debe estar ocupada por especies mejorantes, de las cuales las leguminosas deben representar al menos el 5%. 
* **Flexibilidad:** Se permite que la leguminosa no llegue a producción para ser utilizada como abonado en verde, pudiéndose enterrar sin que la planta alcance el estado de recolección. 

#### 2.1.2. P4. Práctica de siembra directa: 
Se requiere realizar agricultura de conservación (siembra directa, sin arar) en al menos el 40% de la superficie solicitada, y en el total de dicha superficie con siembra directa, se debe rotar, con las siguientes flexibilidades: 
* La superficie de especies plurianuales no se incluye en la rotación exigida, a menos que sea el año de implantación de un nuevo cultivo tras el ciclo plurianual, en cuyo caso se incluye como superficie base. 
* La existencia de un cultivo secundario en el mismo año también se considerará rotación. 
* Las labores del terreno no están permitidas, aunque la autoridad competente puede autorizar excepcionalmente labores verticales (sin volteo). 

#### 2.1.3. P5. Práctica de espacios de biodiversidad (tierras de cultivo y cultivos permanentes) 
Esta práctica exige destinar un porcentaje de la superficie total acogida a superficies o elementos no productivos. 
* 7% en tierras de cultivo de secano. 
* 4% en tierras de cultivo de regadío y cultivos permanentes. 
...
² Medidas: Nivelación anual del terreno, siembra en seco con inundación a los 30-45 días, secas intermitentes para tratamientos, construcción de caballones. 

### 2.2. Prácticas en superficies de pastos 

#### 2.2.1. P1. Práctica de pastoreo extensivo 
Flexibilidades en el período de pastoreo y cargas ganaderas.  Las autoridades competentes pueden:
* Reducir el período de pastoreo de 120 a 90 días por causas justificadas y condiciones agroclimáticas. 
* Ajustar las cargas ganaderas (mínima y máxima) en circunstancias excepcionales o fuerza mayor (ej. condiciones climáticas severas). 

#### 2.2.2. P2. Práctica de siega sostenible 
Establece un período improductivo de 60 días entre junio, julio y agosto.  Las CC.AA. definen cuáles 60 días consecutivos son el período improductivo, permitiendo adaptaciones a cada campaña. 
...
Las comunidades autónomas pueden definir el período de cuatro meses en que la cubierta debe permanecer viva (entre el 1 de octubre y el 31 de marzo).  También pueden reducir este período en circunstancias justificadas por condiciones agroclimáticas adversas o fuerza mayor.  Se permite la aplicación de fitosanitarios sobre la cubierta para prevención, control o erradicación de plagas. 
...
Las comunidades autónomas pueden permitir, excepcionalmente, labores de mantenimiento de las cubiertas, bajo ciertas limitaciones (ej. no modificar la estructura del suelo), en virtud de las características agronómicas de la zona. 
...
* En parcelas de tierras de cultivo donde se solicite un eco régimen mediante la práctica P3 (Rotaciones) o P4 (Siembra Directa), se deben respetar los requisitos propios de estas prácticas y no será necesaria la diversificación de cultivos de la BCAM 7.  Además, en dichas parcelas, la explotación puede acogerse a la derogación de la BCAM 8; es decir, se pueden percibir las ayudas del eco régimen si se cumplen los requisitos de la práctica P3 o P4, aunque no se destine superficie a barbecho u otros elementos no productivos. 
* Si el agricultor decide acogerse a la práctica P5 (espacios de biodiversidad) en parte de sus parcelas de tierras de cultivo, deberá respetar para la totalidad de las tierras de cultivo de la explotación los requisitos de la BCAM 8, como si no hubiera habido derogación. 
* Si mediante la aplicación del eco régimen se alcanza un porcentaje de superficies y elementos no productivos en las tierras de cultivo de la totalidad de la explotación del 7%, la explotación deberá alcanzar un porcentaje de superficies y elementos no productivos definidos en la BCAM del 3%. 
* En caso contrario (no se alcanza el 7%), la explotación deberá alcanzar un porcentaje de superficies y elementos no productivos definidos en la BCAM, de un 4%. 

---

## ANEXO I: Ejemplos de aplicación parcial de eco regímenes 

**Ejemplo 1:** 
Explotación de 100 hectáreas de tierras de cultivo (50 de secano + 50 de regadío). El agricultor decide: 
* No acogerse a ninguna práctica en las 50 ha de regadío. 
* Acogerse a la práctica de rotación en las 50 ha de secano: 
    * Rotación en al menos 25 ha (50% de 50 ha). 
    * Al menos 5 ha de especies mejorantes (10% de 50 ha). 
    * Al menos 2,5 ha de leguminosas (5% de 50 ha). 
* Percibirá ayuda por la práctica de rotación por las 50 ha acogidas (con importe correspondiente al secano). 

**Ejemplo 2:** 
100 hectáreas de tierras de cultivo (50 de secano + 50 de regadío). El agricultor decide: 
* No acogerse a ninguna práctica en 25 ha de regadío. 
* Acogerse a la práctica de rotación en las 50 ha de secano: 
    * Rotación en 25 ha (50% de 50 ha), sin excepciones. 
    * Al menos 5 ha de especies mejorantes (10% de 50 ha). 
    * Al menos 2,5 ha de leguminosas (5% de 50 ha). 
...
* Acogerse a la práctica de siembra directa en 25 ha de regadío: 
    * Siembra directa en al menos 10 ha (40% de 25 ha). 
    * Rotación en esas 10 ha. 
...
* Acogerse a la práctica de rotación en 40 ha de secano: 
    * Rotación en al menos 20 ha (50% de 40 ha), sin excepciones. 
    * Al menos 4 ha de especies mejorantes (10% de 40 ha). 
    * Al menos 2 ha de leguminosas (5% de 40 ha). 
...
* Acogerse a la práctica de siembra directa en 30 ha de regadío: 
    * Siembra directa en al menos 12 ha (40% de 30 ha). 
    * Rotación en esas 12 ha. 
...
*Nota: Esta tabla es la correspondiente al Anexo XVII del proyecto de RD de intervenciones PEPAC* 

| Tipo de superficie y elemento no productivo | Factor de conversión (m/árbol a m²) | Factor de ponderación | Superficie resultante |
|---|---|---|---|
| Tierras en barbecho de biodiversidad (por 1 m²) | No procede | 1,5 | 1,5 m²  |
...
| Islas o Enclaves (Islas o enclaves de vegetación natural o roca) y majanos (por 1 m²) | No procede | 1 | 1 m²  |
| Islas de biodiversidad (por 1 m²) | No procede | 1,5 | 1,5 m²  |
| Muros de piedra (por 1 m) | 1 | 1 | 2 m²  |
| Pequeñas construcciones de arquitectura tradicional (por 1 m²) | No procede | 1 | 1 m²  |
| Zonas de no cosechado de cereal y oleaginosa (por 1 m²) | No procede | 1 | 1 m²  |